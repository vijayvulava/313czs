...
```{figure} https://thecivilengineering.com/wp-content/uploads/2024/06/suman-1200-x-628-px-15.jpg
---
...
Image source: [Thiessen Polygon Method: Procedure, Numerical, and Solutions](https://thecivilengineering.com/thiessen-polygon-method-overview/)
```
...
$$
\% \text{Area} = \frac{\text{No. of Pixels in polygon }}{\text{No. of Pixels in Extent}} \times 100\%
$$
...
Setting all the calculations in a table, we can see that the  precipitation for the entire basin is 1047.2 mm
...
\begin{equation}
	\dfrac{\dfrac{1}{1.2}\times 985 + \dfrac{1}{3.8} \times 1015 + \dfrac{1}{6.4} \times 1101}{\dfrac{1}{1.2}+\dfrac{1}{3.8}+\dfrac{1}{6.4}} = 1005.8\,  \text{mm}
\end{equation}
...
$$
\text{Weighted Precip} = \frac{1005.8+994.8+993.6+1070.3+1060.7+1052.0}{6} = 1029.5\,  \text{mm}
$$
