...
T-tests are statistical tools for comparing the means of two groups within large datasets. They are especially useful when the data originates from normally distributed populations, and the variances are unknown.
