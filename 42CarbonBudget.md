...
Organisms that obtain food energy by feeding on other organisms or organic compounds they produce are called heterotrophs. When heterotrophs consume another organism, the energy stored in the organic compounds is released through one of two metabolic processes. Organisms that cannot tolerate $\ce{O2}$ derive their energy through anaerobic fermentation, where carbohydrate molecules partially decompose to produce alcohol, $\ce{CO2}$, and $\ce{H2O}$ while releasing energy. On the other hand, heterotrophs that can tolerate $\ce{O2}$ extract their energy through the aerobic process known as respiration (or cellular respiration). This process uses $\ce{O2}$ to break down carbohydrates, releasing $\ce{CO2}$, $\ce{H2O}$, and energy. Respiration is significantly more efficient than fermentation as a metabolic process.
...
figclass: margin-caption
---
Plant carbon allocation in a changing world. Plants allocate carbohydrates produced during photosynthesis to support maintenance, growth, development, reproduction, defense, and communication.  Image source: [Plant carbon allocation in a changing world – challenges and progress - New Phytologist](https://doi.org/10.1111/nph.16757)
```
...
5. Climate-Carbon Cycle Feedback Relationship: 
   ...
   \end{align}$$
    Where:
	- $NPP$ and $R_h$ are functions of temperature ($T$), precipitation ($P$), and atmospheric CO$_2$ concentration
